...
### Corrección v3
Se corrigió la lectura de Excel con encabezados repetidos. El error
`TypeError: arg must be a list, tuple, 1-d array, or Series` ocurría porque
`d[stock]` podía devolver varias columnas en lugar de una Series. La versión
actual selecciona la columna por posición y garantiza una Serie 1-D.
