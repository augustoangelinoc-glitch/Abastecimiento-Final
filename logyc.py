...
def calculate(stock, salidas, oc=None, ingresos=None):
    ...
    # ---------------- ABASTECIMIENTO ----------------
    # Método base: demanda histórica + stock de seguridad.
    # En demanda intermitente/eventual no se fuerza una compra.
    def ss(r):
        y=np.array([r[c] for c in month_cols],float)
    ...
    lt=o.lead_time_dias.fillna(0)
    o["punto_pedido"]=o.consumo_diario*lt+o.stock_seguridad
